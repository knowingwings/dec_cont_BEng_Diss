...
#ifndef DEC_CONTROL__SRV__DETAIL__SUBMIT_BID__FUNCTIONS_H_
#define DEC_CONTROL__SRV__DETAIL__SUBMIT_BID__FUNCTIONS_H_
...
/// Initialize srv/SubmitBid message.
/**
...
/// Finalize srv/SubmitBid message.
/**
...
/// Create srv/SubmitBid message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * dec_control__srv__SubmitBid_Request__init().
...
/// Destroy srv/SubmitBid message.
/**
 * It calls
 * dec_control__srv__SubmitBid_Request__fini()
...
/// Check for srv/SubmitBid message equality.
/**
...
/// Initialize array of srv/SubmitBid messages.
/**
...
/// Finalize array of srv/SubmitBid messages.
/**
 * It calls
 * dec_control__srv__SubmitBid_Request__fini()
...
/// Create array of srv/SubmitBid messages.
/**
 * It allocates the memory for the array and calls
 * dec_control__srv__SubmitBid_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SubmitBid messages.
/**
 * It calls
 * dec_control__srv__SubmitBid_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SubmitBid message array equality.
/**
...
/// Copy an array of srv/SubmitBid messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * dec_control__srv__SubmitBid_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dec_control
...
/**
 * It calls
 * dec_control__srv__SubmitBid_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_dec_control
...
/**
 * It allocates the memory for the array and calls
 * dec_control__srv__SubmitBid_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dec_control
...
/**
 * It calls
 * dec_control__srv__SubmitBid_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // DEC_CONTROL__SRV__DETAIL__SUBMIT_BID__FUNCTIONS_H_
