...
#include "dec_control/msg/detail/robot_state__rosidl_typesupport_fastrtps_c.h"
...
using _RobotState__ros_msg_type = dec_control__msg__RobotState;
...
static uint32_t _RobotState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dec_control__msg__RobotState(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dec_control__msg__RobotState;
    is_plain =
      (
...
static size_t _RobotState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dec_control__msg__RobotState(
