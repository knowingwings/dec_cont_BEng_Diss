...
#include "dec_control/msg/detail/task_list__rosidl_typesupport_fastrtps_c.h"
...
#include "dec_control/msg/detail/task__functions.h"  // tasks
...
using _TaskList__ros_msg_type = dec_control__msg__TaskList;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: tasks
  {
    ...
    if (ros_message->tasks.data) {
      dec_control__msg__Task__Sequence__fini(&ros_message->tasks);
    }
...
size_t get_serialized_size_dec_control__msg__TaskList(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TaskList__ros_msg_type * ros_message = static_cast<const _TaskList__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _TaskList__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dec_control__msg__TaskList(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dec_control
size_t max_serialized_size_dec_control__msg__TaskList(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dec_control__msg__TaskList;
    is_plain =
      (
...
static size_t _TaskList__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dec_control__msg__TaskList(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dec_control, msg, TaskList)() {
