...
#include "dec_control/msg/detail/bid__rosidl_typesupport_fastrtps_c.h"
...
using _Bid__ros_msg_type = dec_control__msg__Bid;
...
size_t get_serialized_size_dec_control__msg__Bid(
  const void * untyped_ros_message,
...
static uint32_t _Bid__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dec_control__msg__Bid(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dec_control
size_t max_serialized_size_dec_control__msg__Bid(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dec_control__msg__Bid;
    is_plain =
      (
...
static size_t _Bid__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dec_control__msg__Bid(
...
static message_type_support_callbacks_t __callbacks_Bid = {
  "dec_control::msg",
  "Bid",
  _Bid__cdr_serialize,
...
static rosidl_message_type_support_t _Bid__type_support = {
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dec_control, msg, Bid)() {
  return &_Bid__type_support;
}
