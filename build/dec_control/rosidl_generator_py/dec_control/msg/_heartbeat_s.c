...
bool dec_control__msg__heartbeat__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dec_control.msg._heartbeat.Heartbeat", full_classname_dest, 36) == 0);
  }
  dec_control__msg__Heartbeat * ros_message = _ros_message;
  {  // robot_id
...
PyObject * dec_control__msg__heartbeat__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("dec_control.msg._heartbeat");
