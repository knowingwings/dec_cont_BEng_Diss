...
#include "dec_control/msg/detail/task_list__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dec_control::msg::TaskList & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dec_control::msg::TaskList & ros_message)
{
  // Member: tasks
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dec_control::msg::TaskList;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dec_control::msg::TaskList *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dec_control::msg::TaskList *>(
    untyped_ros_message);
...
{
  return &dec_control::msg::typesupport_fastrtps_cpp::_TaskList__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dec_control, msg, TaskList)() {
  return &dec_control::msg::typesupport_fastrtps_cpp::_TaskList__handle;
}
