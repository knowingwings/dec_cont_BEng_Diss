...
#include "dec_control/msg/detail/robot_state__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: workload
  cdr << ros_message.workload;
  // Member: failed
  cdr << (ros_message.failed ? true : false);
  return true;
}
  ...
  dec_control::msg::RobotState & ros_message)
{
  ...
  // Member: failed
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message.failed = tmp ? true : false;
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: workload
  {
    size_t item_size = sizeof(ros_message.workload);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: failed
  {
    size_t item_size = sizeof(ros_message.failed);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dec_control::msg::RobotState;
    is_plain =
      (
      offsetof(DataType, failed) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const dec_control::msg::RobotState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dec_control::msg::RobotState *>(
    untyped_ros_message);
...
{
  return &dec_control::msg::typesupport_fastrtps_cpp::_RobotState__handle;
}
