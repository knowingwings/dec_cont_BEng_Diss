...
#include "dec_control/msg/detail/task_assignment__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dec_control::msg::TaskAssignment & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dec_control::msg::TaskAssignment & ros_message)
{
  // Member: task_ids
  {
    cdr >> ros_message.task_ids;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dec_control::msg::TaskAssignment;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dec_control::msg::TaskAssignment *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dec_control::msg::TaskAssignment *>(
    untyped_ros_message);
...
{
  return &dec_control::msg::typesupport_fastrtps_cpp::_TaskAssignment__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dec_control, msg, TaskAssignment)() {
  return &dec_control::msg::typesupport_fastrtps_cpp::_TaskAssignment__handle;
}
