...
#include "dec_control/msg/detail/heartbeat__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dec_control::msg::Heartbeat & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dec_control::msg::Heartbeat & ros_message)
{
  // Member: robot_id
  cdr >> ros_message.robot_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dec_control::msg::Heartbeat;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dec_control::msg::Heartbeat *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dec_control::msg::Heartbeat *>(
    untyped_ros_message);
...
{
  return &dec_control::msg::typesupport_fastrtps_cpp::_Heartbeat__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dec_control, msg, Heartbeat)() {
  return &dec_control::msg::typesupport_fastrtps_cpp::_Heartbeat__handle;
}
